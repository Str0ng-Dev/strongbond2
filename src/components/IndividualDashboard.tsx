...
const IndividualDashboard: React.FC<IndividualDashboardProps> = ({ onLogout }) => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // Even if there's an error, call the onLogout callback
      if (onLogout) {
        onLogout();
      }
    }
  ...
  if (currentView === 'user-connections') {
    return (
            ...
            <div className="flex-1">
              ...
              <div className="mb-4">
                ...
                <p className="text-xl text-white text-opacity-90 font-medium">
                  {getRandomMessage(getEncouragementMessage(user.user_role, user.fitness_enabled))}
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <TodaysExperience key={refreshKey} userData={{
              first_name: user.first_name,
              user_role: user.user_role,
              fitness_enabled: user.fitness_enabled,
              group_action: '',
              email: '',
              password: '',
              user_id: user.id
